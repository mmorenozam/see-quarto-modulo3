...
## Operador de cascada (*pipeline operator*) {.smaller}
...
## Separando columnas {.smaller visibility="uncounted" auto-animate="true"}
...
## Preparando el ambiente de trabajo {.smaller}

1)  Crea una carpeta por cada proyecto de trabajo en R en donde tu desees. Puede ser algo como:

![](images/directorio.png){fig-align="center" height="75"}

. . .

2)  Ingresa a la sección de ["Materiales y recursos"](https://mmorenozam.github.io/progR-website/materiales.html){target="_blank"} del curso y descarga el archivo comprimido datos.zip.

. . .

3)  Extrae los archivos en el directorio que creaste.

![](images/directorio2.png){fig-align="center" height="250"}

## Preparando el ambiente de trabajo {.smaller visibility="uncounted"}

4)  En R, crea un nuevo script donde en la primera línea utilizaremos la función `setwd`
...
5)  Guarda el archivo de R en el directorio que creaste (en caso de no haberlo hecho antes).
